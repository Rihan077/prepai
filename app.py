...
def show_main_app():
    ...
    with st.sidebar:
        ...
        st.markdown("---")
        mode = st.selectbox("Mode", ["💬 Study Chat", "🧪 Test Mode", "📅 Study Plan", "📈 Analytics"])
    ...
    if uploaded_file:
        ...
        cards = [
            ("💬", "Study Chat", "Ask questions and get structured 2/5/10 mark answers."),
            ("🧪", "Test Mode",  "Adaptive MCQ quizzes based on your performance history."),
            ("📅", "Study Plan", "Personalized plan built from your PDF and weak areas."),
